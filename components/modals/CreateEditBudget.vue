        ...
        <div class="flex flex-col gap-8">
            ...
            <form ref="form" class="flex flex-col gap-4">
                <label class="block">
                    ...
                    <input v-model="budget.name" @input="handleInput" required minlength="1" maxlength="255"
                        class="mt-1 input-default w-full">
                </label>

                <label class="block">
                    <span class="text-sm">Description (optional)</span>
                    <textarea v-model="budget.description" @input="handleInput" minlength="1" maxlength="4096"
                        class="mt-1 input-default h-24 w-full"></textarea>
                </label>

                <label class="block">
                    <span class="text-sm">Currency</span>
                    <select v-model="budget.currency_iso" required class="mt-1 select-default">
                ...
                <label class="block">
                    ...
                    <div class="flex gap-2 items-center">
                        <input v-model="budget.color_hex" type="color" class="mt-1 color-select-default">
